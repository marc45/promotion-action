...
public class TestZKCluster {
    ...
    private void createZKInstance() throws IOException {
        // 连接到ZK服务，多个可以用逗号分割写
        zk = new ZooKeeper("172.24.7.165:2182,172.24.7.165:2181,172.24.7.165:2183", TestZKCluster.SESSION_TIMEOUT, this.wh);
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        TestZKCluster dm = new TestZKCluster();
        dm.createZKInstance();
        dm.ZKOperations();
        //dm.ZKClose();
    }
